...
def get_sales_percentage(fuel_type, year):
    ...
    elif constants.scenario_type is 3: 
        new_sales_percentage_petrol = base_sales_petrol- 0.02*(year - constants.BASE_YEAR)
        print(new_sales_percentage_petrol)
    elif constants.scenario_type is 4: 
        new_sales_percentage_petrol = base_sales_petrol- 0.01*(year - constants.BASE_YEAR)
        print(new_sales_percentage_petrol)
